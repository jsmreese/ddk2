	...
	"listElement": {
		...
		"options": {
			...
			"listClassName": {
				...
				"notes": "<p>The class <code>compact</code> will remove spacing between list items.<p>The classes <code>small</code>, <code>medium</code>, and <code>large</code> will affect button size in <code>button</code> list mode.<p>The class <code>vertical</code> will render tabs in vertical mode instead of the default horizontal."
			},
