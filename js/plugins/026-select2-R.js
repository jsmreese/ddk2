...
(function ($, undefined) {
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        positionDropdown: function() {
            var alignSearch = this.opts.alignSearch, // added option alignSearch to get rid of the extra space in the dropdown before the search field
				offset = this.container.offset(),
                height = this.container.outerHeight(),
                width = this.container.outerWidth(),
                dropHeight = this.dropdown.outerHeight(),
                viewportBottom = $(window).scrollTop() + document.documentElement.clientHeight,
                dropTop = offset.top + height - (alignSearch ? 20 : 0), // if alignSearch is set to true, search field is better aligned with the select label
