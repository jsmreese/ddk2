	...
	$.jstree.plugin("core", {
		...
		_fn : {
			...
			save_opened : function () {
				...
				// DDK modified 3/1/2013 - old code: this.get_container_ul().find("li.jstree-open").each(function () {
				this.get_container_ul().find("li.jstree-open:visible").each(function () {
	...
	$.jstree.plugin("themes", {
		...
		_fn : {
			set_theme : function (theme_name, theme_url) {
				...
				/* DDK modified 3/1/2013 - removed because style.css is added inside ddk.css
...
(function ($) {
	$.vakata.xslt = function (xml, xsl, callback) {
		var r = false, p, q, s;
		// IE9
		if(r === false && (window.ActiveXObject !== undefined || "ActiveXObject" in window)) {
			try {
...
(function ($) {
	$.jstree.plugin("types", {
		__init : function () {
			...
			if(is_ie6 || ($.browser.msie && ($.browser.version === "9.0")) ) {
				this.get_container()
