			...
			$buttons = $("<div>" + buttons.groups.reduce(function (accumulator, buttonGroup) {
				...
				return accumulator + 
					"<span data-label=\"" + buttonGroup.get("label") + "\">" +
						"<button class=\"toolbar-buttonbar\" data-toolbar=\"" + buttonGroup.id + "\" data-text=\"" + (buttonGroup.get("text") || "") + "\" data-icon=\"" + (buttonGroup.get("icon") || "") + "\" data-values=\"" + _.escape(JSON.stringify(values)) + "\">" +
