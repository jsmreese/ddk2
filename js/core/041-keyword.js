...
(function(window, undefined) {
	...
	function Keyword(key, value, prefix, settings) {
		...
		// handle settings object as value or prefix argument
		if (_.isPlainObject(value)) {
			_.extend(settings, value);
			value = undefined;
		}
		if (_.isPlainObject(prefix)) {
			_.extend(settings, prefix);
			prefix = undefined;
		}
		// Basic Getter/Setter
		...
		if (!_.isEmpty(updatedKeys) && !settings.silent) {
