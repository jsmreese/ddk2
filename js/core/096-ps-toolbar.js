...
$(document).on("mouseenter", "[data-toolbar]", function (e) {
	...
	if ($target.hasClass("toolbar-buttonbar") || $target.parents().hasClass("toolbar-content")) {
		// buttonbars and sub-toolbars will hide on unfocus and click
		...
		// buttonbars will hide all other toolbars
		// but do not have a close button
		if ($target.hasClass("toolbar-buttonbar")) {
